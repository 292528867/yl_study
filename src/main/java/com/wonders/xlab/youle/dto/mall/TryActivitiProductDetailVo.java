 ...
 *
 */
public class TryActivitiProductDetailVo {
    /** 试用商品 */
    ...
    public TryActivitiProductDetailVo() {}

    public TryActivitiProductDetailVo(MallActivitiProduct p) {
    ...
    public TryActivitiProductDetailVo(MallProduct p) {
